...
import styles from "./SharepointPoc.module.scss";
import type { ISharepointPocProps } from "./ISharepointPocProps";
import { escape } from "@microsoft/sp-lodash-subset";
import { CustomDropdown } from "./CustomDropdown";

export default class SharepointPoc extends React.Component<
  ISharepointPocProps,
  {}
> {
  public render(): React.ReactElement<ISharepointPocProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
    ...
    return (
      <section
        className={`${styles.sharepointPoc} ${
